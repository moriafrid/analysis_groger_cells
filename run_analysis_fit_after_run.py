...
for cell_name in cells:
    ...
    for file_type in file_type2read:
        for SPINE_START in SPINE_STARTs[1:]: #SPINE_STARTs
            for double_spine_area in ['True','False']:
                ...
                jobid=os.system(" ".join(['python', 'analysis_fit_after_run.py',cell_name,file_type,resize_diam_by,shrinkage_factor,SPINE_START,double_spine_area,folder_]))
                print(file_type)
