...
for cell_name in cells:
    for file_type in ['ASC','hoc']:
        print(cell_name)
        passive_val_total=read_from_pickle(glob(folder_+folder_save+cell_name+'/fit_short_pulse_'+file_type+'/dend*'+resize_diam_by+'&F_shrinkage='+shrinkage_factor+'/different_initial_conditions/RA0_100:300:2+RA0_50:100:0.5/RA_total_errors_minimums.p')[0])
        passive_vals_dict= {}
