...
from create_Figures import find_RA
...
import numpy as np
cell_name=read_from_pickle('cells_name2.p')[9] #@need to be run forn the consule and the cell number need to be change
...
dict_result=read_from_pickle(glob(base_dir+decided_passive_params+'_results.p')[0])['parameter']
