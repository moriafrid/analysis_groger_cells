...
def run(cell, seed=0):
    ...
    syn_params.append(ephys.parameters.NrnPointProcessParameter(
        ...
        bounds=[0.00001, 3],#yoni:[0.2, 0.4], #04_03_B:[0.05, 0.4]
    ...
    syn_params.append(ephys.parameters.NrnPointProcessParameter(
        ...
        bounds=[0.2, 3],#yoni:[1.4,2.5]  #04_03_B:[0.5, 3]
        locations=tau_param_locs))
    ...
    syn_params.append(ephys.parameters.NrnPointProcessParameter(
        ...
        frozen=False,
        bounds=[3, 20],#yoni:[5,10]  #04_03_B:[3, 20]
    ...
    syn_params.append(ephys.parameters.NrnPointProcessParameter(
        ...
        frozen=False,
        bounds=[25, 120],#[20,90] #04_03_B:[25, 120]
        locations=NMDA_param_locs))
    syn_params.append(ephys.parameters.NrnPointProcessParameter(
        name='NMDA_n_NMDA',
        param_name='n_NMDA',
    ...
    #
    ##################################################################################
    feature1 = EFeatureRDSM(T_base, V_base, extra_rec='EFeatureRDSM.')
    feature2 = EFeaturePeakTime(T_base, V_base, extra_rec='EFeaturePeakTime.')
    feature3 = EFeaturePeak(T_base, V_base, exp_std=0.05, extra_rec='EFeaturePeak.')
    #short_pulse_features
    feature4 = EFeatureRin(V_short_pulse, exp_std=0.05, extra_rec='EFeatureRin.', cell_name=cell_name)
    feature5 = EFeatureDecay(V_short_pulse, exp_std=0.05, extra_rec='EFeatureDecay.', cell_name=cell_name)
    ...
    objectives = [objective1, objective3, objective4,objective5]
    ...
    cell_evaluator = ephys.evaluators.CellEvaluator(
        ...
        fitness_protocols={'all_protocols': all_protocols},  # "Rin2":protocol3
    ...
    if stim_befor:
        ...
        responses = all_protocols.run(cell_model=model, param_values=start_values, sim=sim)
    ...
    responses = all_protocols.run(cell_model=model, param_values=best_ind_dict, sim=sim)
