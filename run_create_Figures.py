...
if len(sys.argv)!=3:
    ...
    specipic_moo='total_moo'# correct_seg_syn_find_syn_xyz
    print('sys.argv isnt run',len(sys.argv),sys.argv)
else:
    sec_from_picture=eval(sys.argv[1])
    specipic_moo=sys.argv[2]
before_after='_after_shrink'
specipic_cell="None"
os.system('python csv_for_MOO_results_final.py')
for specipic_moo in ['total_moo']:#['correct_seg_syn_from_picture','correct_seg_find_syn_xyz']:
    ...
    os.system(base+" create_Figure5.py ")
    os.system(base+" create_Figure_linear_fit.py ")
    os.system(base+" create_Figure_diffrent_RA_in_cell.py ")
